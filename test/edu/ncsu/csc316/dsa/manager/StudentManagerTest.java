...
/**
 * Test Class for StudentManager.java
 * @author jrschmie Jacob Schmiedl
 */
public class StudentManagerTest {

	/** Student Manager object that is used */
	private StudentManager sm;
	
	/**
	 * Giving the file for StudentManager to read from
	 */
	@Before
	public void setUp() {
	...
	/**
	 * Tests and see if the csv file is sorted
	 */
	@Test
