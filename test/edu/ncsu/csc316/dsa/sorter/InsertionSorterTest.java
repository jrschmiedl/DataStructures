...
/**
 * Test Class for InsertionSorter.java
...
public class InsertionSorterTest {
	...
	/** Sorter that allows the integers to be sorted by InsertionSorter */
	private InsertionSorter<Integer> intSorter;
	/** Sorter that allows the student to be sorted by InsertionSorter */
	private InsertionSorter<Student> studentSorter;
	
	/**
	 * Setup for the test cases of InsertionSorter
	 */
	@Before
	public void setUp() {
		intSorter = new InsertionSorter<Integer>();
		studentSorter = new InsertionSorter<Student>();
	}
	
	/**
	 * Tests the Comparator for InsertionSort
	 */
	@Test
