...
/**
 * Test Class for MergeSorter.java
...
public class MergeSorterTest {
	...
	/** Sorter that allows the integers to be sorted by MergeSorter */
	private MergeSorter<Integer> intSorter;
	/** Sorter that allows the student to be sorted by MergeSorter */
	private MergeSorter<Student> studentSorter;

	
	/**
	 * Setup for the test cases of MergeSorter
	 */
	@Before
	public void setUp() {
		intSorter = new MergeSorter<Integer>();
		studentSorter = new MergeSorter<Student>();
	}
	
	/**
	 * Tests the Comparator for MergeSort
	 */
	@Test
